...
Item {
    ...
    // Sankt Petersburg und Buenos Aires genau auf der Kante des Kartenrechtecks.
    // Würfel und Figuren werden aber neben die Stadt gezeichnet und fielen damit
    // aus dem sichtbaren Bereich — und antippen ließen sich die Städte auch
    // nicht. Deshalb ist die Fläche zum Schieben ringsum breiter als die Karte.
    readonly property real pad: Theme.itemSizeExtraSmall * 0.9
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            ...
                            Column {
                                ...
                                Repeater {
                                    // modelData ist die Sitznummer, die Farbe holt
                                    // sich die Figur über die Rolle auf dem Sitz
                                    model: city.pawns
                                    delegate: Rectangle {
