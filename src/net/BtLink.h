...
// Bluetooth for a shared game, taken over from harbour-snapszer. An RFCOMM link carries exactly the same
...
// Harmattan hands out to headsets and OBEX. Snapszer holds 21.
